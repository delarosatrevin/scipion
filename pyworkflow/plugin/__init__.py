...
from pyworkflow.protocol import Protocol, Object
...
class Domain:
    ...
    @classmethod
    def getObjects(cls):
        """ Return all Object subclasses from all plugins for this domain.
        """
        return cls.__getSubclasses('objects', Object)
    ...
    @classmethod
    @abstractmethod
    def registerPluginBinaries(cls):
        """ Must be implemented by children. They must define their binaries
...
def findWizards(protocol, environment):
    """ Find available wizards for this class.
    Returns:
